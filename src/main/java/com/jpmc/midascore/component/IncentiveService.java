...
public class IncentiveService {
    ...
    public float getIncentive(Transaction transaction) {
        try {
            ...
            if (incentive != null) {
                logger.debug("Received incentive: {} for transaction: {}", incentive.getAmount(), transaction);
            ...
            logger.error("Error calling incentive API for transaction: {}. Error: {}", transaction, e.getMessage());
            return 0.0f;
        }
    }
}